          ...
          <div className={styles['intro-section__wrapper']}>
            <div className={styles['intro-section__description']}>
              ...
              <p>
                ...
                ducimus voluptates aliquid tempore laboriosam unde nam,
                inventore voluptatibus nisi consequuntur dignissimos quis quod,
                labore qui sequi. Suscipit excepturi unde corporis! Nostrum nam
                distinctio, odio cum a maiores aliquid nesciunt fuga voluptatum,
                sunt voluptate, sequi quia debitis recusandae impedit possimus
                repellendus quasi accusamus placeat facilis doloremque maxime
                libero hic. Laboriosam, qui! Veritatis perspiciatis sit
                doloremque deleniti perferendis. Voluptas consequatur sunt
                repellendus aliquam voluptate consectetur laboriosam rerum,
                voluptatum officia totam beatae provident sapiente repellat,
                molestias quae. Illo soluta iste eligendi sit dignissimos! In
                optio, voluptatum accusantium saepe, odio cumque dolore ducimus
                iste id, architecto minima error iusto magnam ipsam. Ipsa, sunt
                facere, error iure aspernatur eligendi provident natus odio
                labore iste numquam!
              </p>
            </div>
